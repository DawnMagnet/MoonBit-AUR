...
const INFO_URL = "https://cli.moonbitlang.com/binaries/latest/moonbit-linux-x86_64.sha256"
...
const VSCODE_EXTENSION_URL = "https://marketplace.visualstudio.com/_apis/public/gallery/extensionquery";
...
async function getVSCodeExtensionVersion() {
    ...
    while (retries > 0) {
        try {
            console.log(`尝试第 ${31 - retries} 次请求...`);
            const response = await axiosInstance.post(VSCODE_EXTENSION_URL, requestData);
...
const PKGBUILD = `pkgname=moonbit-bin
pkgver=${version}
pkgrel=1
